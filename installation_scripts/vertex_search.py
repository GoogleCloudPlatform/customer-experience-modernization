...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_store_id", help="name for data_store", type=str)
    parser.add_argument("--engine_id", help="Search App name", type=str)
    parser.add_argument("--gcs_uri", help="GCS url for data import", type=str)
    ...
    try:
        with open("marketingEnvValue.json", "r") as jsonFile:
            ...
            data[f"{engine_id}_search"] = engine_id
            data[f"{engine_id}_datastore"] = data_store_id
        with open("marketingEnvValue.json", "w") as jsonFile:
            json.dump(data, jsonFile)
    except:
        print("Unknow Error!!!, Please rerun the automation")
